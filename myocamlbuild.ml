...
dispatch begin
  ...
  | After_rules ->
    ...
    dep ["ocaml"; "link"; "byte"; "library"; "use_osx_attr_stubs"]
      ["lib/dllosx_attr_stubs"-.-(!Options.ext_dll)];
    flag ["ocaml"; "link"; "byte"; "library"; "use_osx_attr_stubs"] &
    S[A"-dllib"; A"-losx_attr_stubs"];

    dep ["ocaml"; "link"; "native"; "library"; "use_osx_attr_stubs"]
    ...
    flag ["ocaml"; "link"; "byte"; "program"; "use_osx_attr_stubs"] &
      S[A"-dllib"; A"-losx_attr_stubs"];
    dep ["ocaml"; "link"; "byte"; "program"; "use_osx_attr_stubs"]
      ["lib/dllosx_attr_stubs"-.-(!Options.ext_dll)];

    flag ["ocaml"; "link"; "native"; "program"; "use_osx_attr_stubs"] &
      S[A"-cclib"; A"-losx_attr_stubs"];
